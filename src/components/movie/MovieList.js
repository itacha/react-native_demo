...
//   下拉刷新
  ...
  renderCell=({item,index})=>{
      return (
          <TouchableOpacity
            style={{borderBottomColor:"#eee",flexDirection:"row",borderBottomWidth:1,backgroundColor:"#fff",padding:8}}
            activeOpacity={0.7} onPress={()=>{this.goToDetail(item.id)}}>
            <Image style={{width:100,height:140,marginRight:8}}
