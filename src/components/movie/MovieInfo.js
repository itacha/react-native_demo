        ...
        if (this.state.isLoading) {
            ...
            return (
                <ScrollView style={{padding:10}}>
                    ...
                    <Text style={{fontSize:14,color:"#666",padding:10,lineHeight:35}}>
